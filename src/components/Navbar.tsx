...
const Navbar = (props: Props) => {
    const [show,setShow]=React.useState(window.innerWidth<=900?true:false)
    const handleShow=()=>{
  ...
  return (
    ...
    >
      ...
      {show && <img src={samllLogo} alt="logo" />}</Link>
      {!show && (
      ...
      <Stack flexDirection={"row"}>
        ...
        <IconButton type="button" sx={{ p: "14px" }} aria-label="cart">
